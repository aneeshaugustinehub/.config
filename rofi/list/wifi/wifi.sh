...
LIST_THEME="$HOME/.config/rofi/list/wifi/list.rasi"
ENABLE_THEME="$HOME/.config/rofi/list/wifi/enable.rasi"
SSID_THEME="$HOME/.config/rofi/list/wifi/ssid.rasi"
PASSWORD_THEME="$HOME/.config/rofi/list/wifi/password.rasi"
